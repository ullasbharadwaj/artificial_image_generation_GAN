"""
******************************************************************
        Python Script to train a Generative Adversarial
        Network for artificial generation image generation.
...
counter = 0
    ...
    for batchh in dataloaderr:
        ...
        # Clipping weights of discriminator is optional depending on design
        # and requirement
        # for p in Discriminator.parameters():
